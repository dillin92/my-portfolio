...
const About = () => {
    return(
        <section className="my-5 grey">
          ...
          <p>
                    Hello, My name is Dillin Helsley. Im 29 years old and I live in Muncie, Indiana. I have 3 beautiful kids and I am happily engaged with another baby on the way! I currently work at a grocery distribution center for Wal-Mart stores as an order filler. I am ca graduate of Butler Universities Executive Coding Bootcamp. I am eagerly anticipating the day that I enter into the field of web development.
